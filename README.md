...
1. Navigate to the `releases/` directory and download the latest version ZIP (`v1.1.0`).
...
1. Acesse a pasta `releases/` deste repositório e baixe o arquivo `.zip` da versão mais recente (`v1.1.0`).
